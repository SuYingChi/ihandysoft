...
public class SuccessTickView extends View {
    ...
    private static final float CONST_RADIUS = CommonUtils.pxFromDp(1.2f);
    private static final float CONST_RECT_WEIGHT = CommonUtils.pxFromDp(3);
    private static final float CONST_LEFT_RECT_W = CommonUtils.pxFromDp(15);
    private static final float CONST_RIGHT_RECT_W = CommonUtils.pxFromDp(25);
    private static final float MIN_LEFT_RECT_W = CommonUtils.pxFromDp((float) Math.PI);
    private static final float MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + CommonUtils.pxFromDp(3.7f);
