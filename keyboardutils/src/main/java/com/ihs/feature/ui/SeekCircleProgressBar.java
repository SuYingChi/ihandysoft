...
public class SeekCircleProgressBar extends View {
    ...
    public SeekCircleProgressBar(Context context, AttributeSet attrs) {
        ...
        barWidth = a.getDimension(R.styleable.SeekCircleProgressBar_seekBarLineWidth, CommonUtils.pxFromDp(12));
        barHeight = a.getDimension(R.styleable.SeekCircleProgressBar_seekBarLineHeight, CommonUtils.pxFromDp(12));
        ...
        int screenHeight = CommonUtils.getPhoneHeight(context);
