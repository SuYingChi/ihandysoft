 ...
 */
public class DataSetComparator<T> {
    ...
    public static class ResultHandler<T> {
        public void onItemsAdded(Collection<T> oldCollection, Collection<T> newItems) {
            oldCollection.addAll(newItems);
        }
     ...
     */
    public boolean compare(Collection<T> newCollection, Collection<T> oldCollection,
