...
public final class VectorCompat {
    ...
    public static VectorDrawableCompat createVectorDrawable(Context context, @DrawableRes int res) {
        if (res == 0) return null;
        return VectorDrawableCompat.create(context.getResources(), res, null);
    }

    public static void setImageViewVectorResource(Context context, AppCompatImageView appCompatImageView, @DrawableRes int res) {
        VectorDrawableCompat vectorDrawableCompat = createVectorDrawable(context, res);
        if (null != vectorDrawableCompat) {
