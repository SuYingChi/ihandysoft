package com.ihs.feature.cpucooler.recycleitem;
...
public class CpuListSubItem extends AbstractFlexibleItem<CpuListSubItem.SubViewHolder>
    ...
    public class SubViewHolder extends FlexibleViewHolder {
        ...
        public SubViewHolder(View view, FlexibleAdapter adapter) {
            ...
            checkBox = (ThreeStatesCheckBox) view.findViewById(R.id.sub_item_checkbox);
        }
    ...
    public CpuListSubItem(String packageName, String appName, Drawable icon) {
