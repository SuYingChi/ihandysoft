...
public class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private void runRemoveAnimation() {
        ...
        Collections.sort(mPendingRemovals, new Comparator<RecyclerView.ViewHolder>() {
            @Override
    ...
    private void runAddAnimation(boolean removalsPending, boolean changesPending,
        ...
        if (additionsPending) {
            ...
            Collections.sort(mPendingAdditions, new Comparator<RecyclerView.ViewHolder>() {
                @Override
                public int compare(RecyclerView.ViewHolder vh1, RecyclerView.ViewHolder vh2) {
    ...
    private boolean preAnimateRemove(final RecyclerView.ViewHolder holder) {
        clear(holder.itemView);
        return preAnimateRemoveImpl(holder);
    }

    private void doAnimateRemove(final RecyclerView.ViewHolder holder, final int index) {
        animateRemoveImpl(holder, index);
        mRemoveAnimations.add(holder);
    }

    @Override
    public final boolean animateRemove(final RecyclerView.ViewHolder holder) {
        endAnimation(holder);
    ...
    private boolean preAnimateAdd(final RecyclerView.ViewHolder holder) {
        clear(holder.itemView);
        return preAnimateAddImpl(holder);
    }

    private void doAnimateAdd(final RecyclerView.ViewHolder holder, final int index) {
    ...
    /* ==== */
    @Override
    public final boolean animateMove(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
