    ...
    class NativeAdTimer {
        ...
        boolean isExpired() {
            ...
            if (totalDisplayDuration < refreshInterval) {
                HSLog.e(poolName + " - not expired: " + totalDisplayDuration);
                return false;
            }
            HSLog.e(poolName + " - expired: " + totalDisplayDuration);
            return true;
        }
