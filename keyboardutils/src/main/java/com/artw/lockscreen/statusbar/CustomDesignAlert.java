...
public class CustomDesignAlert extends AlertDialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.locker_custom_design_alert);
        ...
        int width = (int) getContext().getResources().getFraction(R.fraction.design_dialog_width, DisplayUtils.getScreenWidthPixels(), DisplayUtils.getScreenWidthPixels());
