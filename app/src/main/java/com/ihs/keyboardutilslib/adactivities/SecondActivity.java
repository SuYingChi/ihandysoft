...
public class SecondActivity extends HSActivity implements INotificationObserver{
    ...
    private MainActivity.TimeAdapter timeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ad_second_activity);
        ...
        timeAdapter = new MainActivity.TimeAdapter(this, adTimes);
    ...
    static class TimeAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            MainActivity.TimeAdapter.ViewHolder holder;
            if(convertView == null){
                convertView = new TextView(context);
                holder = new MainActivity.TimeAdapter.ViewHolder();
                holder.time = (TextView) convertView;
                convertView.setTag(holder);
            }
            else {
                holder = (MainActivity.TimeAdapter.ViewHolder) convertView.getTag();
            }
